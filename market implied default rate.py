...
'''
def getCashflow(upb,rate,cdr,sev,rfr,freq,PeriodMax=19):
    '''
    upb : initial balance
    rate : coupon
    cdr : constant d
...
#getCashflow(upb,rate,cdr,sev,rfr,freq,PeriodMax=19)
[df,Price,CheckCumSev,AssetPrice] = getCashflow(upb,Coupon,CDR,SEV,Freq,PeriodMax)
